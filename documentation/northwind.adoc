...
This allows more flexibility in thinking about the data and in evolving it.0
...
In this example, you can find who shipped an order and you can also reverse that and find what orders were
shipped.
...
https://github.com/neo4j-graph-examples/northwind/blob/main/import/northwind-data-importer-mode-data.zip?raw=true[Download Northwind sample data zip file]
...
For you next steps, a suggestion is to look at furthering your Cypher knowledge or building an application using Neo4j's popular language drivers.
